# Code from: https://github.com/DeepCANFR/DeepCA---Hybrid-Deep-Learning-Cellular-Automata-Reservoir/blob/master/ReCA%20parameter%20space/ReCA_X-bit_memory.py
